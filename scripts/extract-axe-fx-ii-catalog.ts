...
//
//   docs/axe-fx-ii-component-catalog.md
//     Human-readable RE artefact (PUBLIC, ships in repo). Block-type
//     inventory, parameter counts per block, type-applicability gate
//     summary, scenes, key facts. Mirrors the role docs/SYSEX-MAP.md
//     plays for AM4 protocol RE.
//
...
const OUT_MD   = 'docs/axe-fx-ii-component-catalog.md';
