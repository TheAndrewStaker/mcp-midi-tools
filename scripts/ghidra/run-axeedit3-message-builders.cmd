@echo off
REM Headless run of TraceAxeEditIIIMessageBuilders.java.
REM Output:
REM   C:\dev\mcp-midi-tools\samples\captured\decoded\ghidra-axeedit3-message-builders.txt
...
"%HEADLESS%" "%PROJECT_DIR%" "%PROJECT_NAME%" ^
    ...
    -postScript TraceAxeEditIIIMessageBuilders.java
