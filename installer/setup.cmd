...
rem MCP MIDI Tools v0.1.0 — setup script.
rem
...
echo.
echo MCP MIDI Tools v0.1.0 — setup
...
echo   2. Reopen Claude Desktop. The MCP MIDI Tools server appears in the connector panel.
